...
$Global:HTML += @"
		...
		<div class="lightbox" id="consolediv">
				<div id="consoleholder">
					<div class="sidemenu">
						<div id="deviceoverviewbutton" class="menuitem"><img id="devicesoverviewicon" src="images/deviceicons/viprion_c2400.png" alt="c2400"/> Device overview</div><!-- To remove the space between the items.
